...
<%
'Start drafts module stuff
setAppPerms "drafts","iName" 'Get the group access permissions
draftsButtons = ""
if bAppRead then 'If the member belongs to a group with "read" access, they have access to the module
    draftsButtons = "save,open,|,"
end if
'End drafts module stuff
		
if editorFull = true then %>
		
		plugins : "save,style,table,advhr,advimage,advlink,emotions,iespell,preview,zoom,print,contextmenu,paste,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template",
		theme_advanced_buttons1 : "preview,print,newdocument,|,styleselect,formatselect,fontselect,fontsizeselect",
		theme_advanced_buttons2 : "<% =draftsButtons %>cut,copy,paste,pastetext,pasteword,|,bullist,numlist,|,outdent,indent,|,undo,redo,|,link,unlink,anchor,|,forecolor,backcolor,|,iespell",
...
<% Else %>
		...
		theme_advanced_buttons2 : "<% =draftsButtons %>cut,copy,paste,pastetext,pasteword,|,bullist,numlist,|,undo,redo,|,link,unlink,|,forecolor,backcolor,|,iespell,advhr",
